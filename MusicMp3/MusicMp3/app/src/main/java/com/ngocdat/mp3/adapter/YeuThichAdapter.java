...
import static com.ngocdat.mp3.fragment.YeuThichFragment.emty;
...
public class YeuThichAdapter extends RecyclerView.Adapter<YeuThichAdapter.ViewHolder> {
    ...
    public YeuThichAdapter() {

    }

    public YeuThichAdapter(Context context, ArrayList<BaiHat> list) {
    ...
    public YeuThichAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.one_yeuthich, parent, false);
